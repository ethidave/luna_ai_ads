...
import { paypalService, PayPalPaymentData } from "@/lib/services/paypalService";
import {
  X,
  CreditCard,
  Wallet,
  ...
  const handlePayment = async () => {
    ...
    try {
      if (selectedMethod === "paypal") {
        ...
        const result = await paypalService.createOrder(paypalData);
        ...
        >
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Please login to your account to continue with the payment process.
            </p>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-left flex-1">
                          <div className={`font-semibold ${colors.textColor}`}>
                            {method.name}
                          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 rounded-lg p-4">
                    <p className="text-sm text-blue-700">
                      Secure payment processing powered by Stripe. Your payment
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Leave empty to use your PayPal account email
                      </p>
                    </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-yellow-600 mt-1">
                            ...
                            payment securely. PayPal protects your financial
